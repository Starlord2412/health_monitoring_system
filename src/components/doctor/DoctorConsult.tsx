...
export function DoctorConsult() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Glass container */}
      <div className="grid grid-cols-1 gap-4 rounded-3xl bg-white/85 p-5 shadow-[0_18px_40px_rgba(15,118,110,0.18)] backdrop-blur lg:grid-cols-[minmax(0,1.1fr)_minmax(0,2fr)]">
        {/* Chats list */}
            ...
            {mockChats.map((chat) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">{chat.patient}</p>
